...
public class VerifyConfig {
    ...
    // 有盾回显
    public static final String RETURN_URL = "http://47.91.219.7/#/callback";

    // 有盾回调
    public static final String CALLBACK_URL = "http://47.91.219.7/agentNotifyInfo/verifyCallback";
