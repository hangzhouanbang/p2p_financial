...
public class AgentIncome {
    ...
    private static final String notify_url = "http://47.96.20.47:2020/agentNotifyInfo/incomeNotify";
...
//        System.out.println(josn);
    ...
    public static void main(String[] args) {
        System.out.println(JSON.toJSONString(income(0.5, "0011", "alipay")));

//        System.out.println(queryIncome("0008"));
    }
